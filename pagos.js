        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function recordWalletTransaction(amountUSD) {
                ...
                const entry = {
                    ...
                    type: 'withdraw',
                    status: 'completed',
                    description: orderNumber ? `Compra LatinPhone ${orderNumber}` : 'Compra LatinPhone',
                    origin: 'latinphone',
                    amount: Number.isFinite(amountValue) ? Number(amountValue.toFixed(2)) : 0,
                    amountBs: Number.isFinite(amountValue) ? Number((amountValue * exchangeRate).toFixed(2)) : 0,
                    currency: 'USD',
            ...
            function finalizeWalletWithdrawal(amountUSD) {
                ...
                const transaction = recordWalletTransaction(amountUSD);
        ...
        function saveOrderData() {
            ...
            function continueAfterNationalization() {
                if (!walletUpdatedForCurrentOrder && lastPurchaseTotalUSD > 0) {
                    finalizeWalletWithdrawal(lastPurchaseTotalUSD);
